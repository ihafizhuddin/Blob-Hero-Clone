    ...
    public partial class UIStepper : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler
    {
        ...
        public UISlider targetSlider
        {
            ...
            private set
            {
                ...
                {
                    TargetSlider.OnValueChangedCallback.RemoveListener(OnTargetSliderValueChanged);
                    OnValueChanged.RemoveListener(UpdateTargetSliderValue);
                }

                if (value != null)
                {
                    value.OnValueChangedCallback.AddListener(OnTargetSliderValueChanged);
        ...
        /// <summary> Fired when the value changed </summary>
        public FloatEvent OnValueChanged = new FloatEvent();

        /// <summary> Fired when the value increases </summary>
        public FloatEvent OnValueIncremented = new FloatEvent();

        /// <summary> Fired when the value decreases </summary>
        ...
        protected virtual void OnEnable()
        {
            ...
            if (TargetSlider)
            {
                TargetSlider.OnValueChangedCallback.AddListener(OnTargetSliderValueChanged);
                OnValueChanged.AddListener(UpdateTargetSliderValue);
            }
        ...
        public void IncrementValue(float increment)
        {
            ...
            {
                OnValueIncremented.Invoke(value); //invoke the OnValueIncremented event only if the value was not already at max
        ...
        public void DecrementValue(float decrement)
        {
            ...
            {
                OnValueDecremented.Invoke(value); //invoke the OnValueDecremented event only if the value was not already at min
